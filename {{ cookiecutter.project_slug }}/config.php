...
$CFG->dbhost    = 'db-mysql';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = '{{ cookiecutter.db_name }}';     // database name, eg moodle
$CFG->dbuser    = '{{ cookiecutter.db_user }}';   // your database username
$CFG->dbpass    = '{{ cookiecutter.db_pass }}';   // your database password
